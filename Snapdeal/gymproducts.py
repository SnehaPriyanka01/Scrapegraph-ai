...
def scrape_snapdeal_data(max_pages=1):
    ...
    while page <= max_pages:
        url = f"https://www.snapdeal.com/products/sports-hobbies-fitness?sort=plrty#bcrumbSearch:wall%20stickers"
        driver.get(url)

        # Allow some time for the page to load
        driver.implicitly_wait(60)  # Adjust the wait time as needed

...
def scrape_snapdeal_data(max_pages=1):
    ...
    # options.add_argument("--headless")  # Remove this line to run in normal mode
    ...
    while page <= max_pages:
        url = f"https://www.snapdeal.com/search?keyword=kitchen%20product&noOfResults=20&clickSrc=CatTrending&categoryId=0&searchCatRedirect=Home%20Audio%20Systems&searchState=&sort=rlvncy#bcrumbLabelId:46102431"
        driver.get(url)
